...
def format_registration_validation_error(exc: ValidationError) -> str:
    messages = []
    for error in exc.errors():
        field_name = error["loc"][-1]
        message = REGISTRATION_ERROR_MESSAGES.get(field_name)
...
async def registration_post(
    ...
    try:
        ...
        return render_template(
            ...
            "registration.html",
            build_registration_context(
                format_registration_validation_error(exc),
